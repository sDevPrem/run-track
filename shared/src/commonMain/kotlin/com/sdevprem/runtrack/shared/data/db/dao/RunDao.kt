...
interface RunDao {
    ...
    suspend fun getRunStatsInDateRange(fromDate: LocalDateTime?, toDate: LocalDateTime?): List<Run>
    ...
    fun getTotalRunningDuration(fromDate: LocalDateTime?, toDate: LocalDateTime?): Flow<Long>
    ...
    fun getTotalCaloriesBurned(fromDate: LocalDateTime?, toDate: LocalDateTime?): Flow<Long>
    ...
    fun getTotalDistance(fromDate: LocalDateTime?, toDate: LocalDateTime?): Flow<Long>
    ...
    fun getTotalAvgSpeed(fromDate: LocalDateTime?, toDate: LocalDateTime?): Flow<Float>
